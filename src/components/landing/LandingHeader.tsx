      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            {isAuthenticated ? (
              <Button
                asChild
                className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5"
              >
        ...
        >
          <nav className="flex flex-col gap-4">
            <a
              href="#why"
              className="text-foreground font-bold hover:text-primary transition-colors duration-200"
            >
              Why ZestComply
            </a>
            <a
