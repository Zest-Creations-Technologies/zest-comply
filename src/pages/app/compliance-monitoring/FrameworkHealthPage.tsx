import { FrameworkTable, SimpleProgressList } from "./MonitoringShared";
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <SimpleProgressList title="Evidence Coverage" description="Evidence coverage supporting framework controls." rows={frameworkHealth.map((item) => ({ label: item.name, value: item.evidenceCoverage }))} />
      </div>
